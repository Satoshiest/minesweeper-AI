...
class MinesweeperAI():
        ...
        for sentence in self.knowledge:
            if new_sentence.cells and sentence.cells != new_sentence.cells:
                if sentence.cells.issubset(new_sentence.cells):
                    more.append(Sentence(new_sentence.cells-sentence.cells,
                                         new_sentence.count-sentence.count))
                if new_sentence.cells.issubset(sentence.cells):
                    more.append(Sentence(sentence.cells-new_sentence.cells,
    ...
    def make_random_move(self):
        ...
        """
        moves_left = set(itertools.product(range(0, self.height),
                                           range(0, self.width)))
